...
const publicComps = [
  ...
  { id: "article", label: "Article", route: "/visceral-mag/send-a-text-before-you-knock", stackOrder: "metadata-title-body-related-comments", note: "Metadata, title, body, related links, and comments stay readable." },
