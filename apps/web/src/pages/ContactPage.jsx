...
function ContactField({ field }) {
  ...
  if (field.type === "select") {
    return (
      <label htmlFor={field.id} data-field={field.purpose}>
        {field.label}
...
export function ContactPage({ fixtures = launchFixtures }) {
  ...
  return (
    <section className="figma-public-page figma-contact-page" data-page="contact" data-route={model.route.path} data-generated={model.generatedFrom} data-prototype-file={model.route.prototypeFile}>
      ...
      <section className="figma-contact-layout">
        ...
        <form
          ...
          noValidate
        >
          {form.fields.map((field) => <ContactField key={field.name} field={field} />)}
