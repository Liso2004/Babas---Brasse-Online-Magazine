...
import { buildServerErrorRouteModel } from "./errorSupportRouteModel.js";
...
export function ServerErrorPage() {
  const model = buildServerErrorRouteModel();

  return (
    <section className="figma-support-page figma-error-page figma-server-error-page" data-page="server-error" data-route={model.route.path} data-generated={model.generatedFrom} data-prototype-file={model.route.prototypeFile} data-support-route="error" data-responsive={model.responsive}>
      <FigmaSupportPanel className="figma-support-hero" data-section="server-error-message">
      ...
      <FigmaSupportGrid className="figma-support-state-grid" data-section="server-error-states" data-state-note={model.sections.states.notes.join(" ")}>
